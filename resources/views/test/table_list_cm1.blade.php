...
<div class="p-2 sm:ml-64  bg-no-repeat bg-cover bg-white bg-blend-multiply">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">CM1</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="p-3 sm:ml-64 bg-no-repeat bg-cover  bg-white bg-blend-multiply">
         ...
         <div class="mt-5">
            <h3 class="mb-2 text-3xl text-center font-bold tracking-tight text-blue-600 dark:text-white">Liste des élèves du CM1</h3> 
