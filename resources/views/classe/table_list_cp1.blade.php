...
@include('partials.sidebar')
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                    ...
                    <li aria-current="page">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">CP1</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="p-8 sm:ml-64 bg-no-repeat bg-cover  bg-white bg-blend-multiply">
         ...
         <!--Div liste élèves-->
         <div class="mt-0">
            <h3 class="mb-2 text-3xl text-center font-bold tracking-tight text-blue-600 dark:text-white">Liste des élèves du CP1</h3> 
