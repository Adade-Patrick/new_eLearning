        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Eleve</span>
                    </div>
                </li>
            </ol>
        </nav>
...
<div class="p-10 sm:ml-64 bg-no-repeat bg-cover bg-white bg-blend-multiply">
    <div class="mt-0">
        ...
        <div class="m-0 flex justify-end px-20">
            <button id="openModalBtn" class="group cursor-pointer outline-none hover:rotate-90 duration-300" title="Ajouter une eleve">
            ...
            <div class="relative shadow-md sm:rounded-lg w-full md:w-3/4">
                ...
                <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
                    ...
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-6 py-4">{{ $eleve->dateNaissance }}</td>
                            ...
                            <form action="{{ route('eleves.destroy', $eleve->id) }}" method="POST" class="inline-block">
                                ...
                                <div id="deleteModal" class="fixed inset-0 flex items-center justify-center invisible">
                                    <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                                        ...
                                        <p>Êtes-vous sûr de vouloir supprimer cet eleve ?</p>
        ...
        <div id="formModal" class="fixed inset-0 flex items-center justify-center invisible">
            <div class="bg-white p-5 rounded shadow-lg w-96">
                <h2 class="text-lg font-bold mb-4 text-center">Ajouter un élève</h2>
                <form id="eleveForm" action="{{ route('eleves.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="date" class="block text-sm font-medium text-gray-700">Date de naissance</label>
                        <input type="date" id="date" name="date" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" required min="2000" max="2099">
                    </div>

                    <div class="mb-4">
                        <label for="telephone" class="block text-sm font-medium text-gray-700">Téléphone</label>
                        <input type="text" id="telephone" name="telephone" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" required min="2000" max="2099">
                    </div>

                    <div class="mb-4">
                        <label for="niveau" class="block text-sm font-medium text-gray-700">Niveau</label>
                        <input type="text" id="niveau" name="niveau" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" required min="2000" max="2099">
                    </div>
