        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Lycée</span>
                    </div>
                </li>
            </ol>
        </nav>
...
<div class="p-6 sm:ml-64  bg-no-repeat bg-cover  bg-white bg-blend-multiply">
    <main class="mt-3 mb-10">

        <section class="">
        
            <div class="px-4 mx-auto max-w-screen-xl text-center py-8 lg:py-10">
                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-blue-600 md:text-5xl lg:text-6xl">Bienvenue au Lycée</h1>
            </div>
            ...
            <button type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-5">Supprimer</button>
                ...
                <div class=" flex md:justify-center flex-col md:flex-row md:space-x-6 space-y-4 md:space-y-0">
                    <a href="">
                        <img class="h-80 max-w-sm w-full" src="{{ asset('images/cycle_lycee/seconde.jpg') }}" alt="">
                    </a>
                    
                    <a href="">
                        <img class="h-80 max-w-sm w-full" src="{{ asset('images/cycle_lycee/1ere.jpg') }}" alt="">
                    </a>
                    
                    <a href="">
                        <img class="h-80 max-w-sm w-full" src="{{ asset('images/cycle_lycee/terminal.jpg') }}" alt="">
                    </a>
