...
<div class="p-10 sm:ml-64 bg-no-repeat bg-cover bg-white bg-blend-multiply">
    <div class="mt-0">
        <h3 class="mb-2 text-3xl text-center font-bold tracking-tight text-blue-600 dark:text-white">Année scolaire</h3>

        <div class="m-0 flex justify-end px-20">
            <button id="openModalBtn" class="group cursor-pointer outline-none hover:rotate-90 duration-300" title="Ajouter une année scolaire">
                                ...
                                <div id="deleteModal" class="fixed inset-0 flex items-center justify-center invisible">
                                    <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                                        ...
                                        <div class="flex justify-end mt-4">
                                            ...
                                            <button id="confirmDelete" class="px-4 py-2 bg-red-600 text-white rounded" onclick="deleteModal()">Supprimer</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <script>
                                    ...
                                    document.getElementById('confirmDelete').addEventListener('click', function() {
                                        if (confirm('Confirmez-vous la suppression ?')) {
                                            alert('Année scolaire supprimée !');
                                            closeModal();
                                        }
                                    });
